...
export const FIREND_REQ_SUCESS = "FIREND_REQ_ACCEPTED";
export const FIREND_RES_REQUEST = "FIREND_RES_REQUEST";
export const FIREND_RES_FAIL = "FIREND_RES_FAIL";
export const FIREND_RES_SUCESS = "FIREND_RES_ACCEPTED";
export const USERDATA_UPDATE_REQUEST = "USERDATA_UPDATE_SUCESS";
export const USERDATA_UPDATE_FAIL = "USERDATA_UPDATE_SUCESS";
